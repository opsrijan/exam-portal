<?php
    ...
    if (isset($_POST['addQuestion'])){
        $_SESSION['currExam']=$_POST['addQuestion'];
    ...
    if (isset($_POST['viewQuestion'])){
        $_SESSION['currExam']=$_POST['viewQuestion'];
                ...
                while ($row=mysqli_fetch_assoc($result)){
                    ...
                    echo "<td>
                        <form action='manageExam.php' method='POST'>
                            <button type='submit' name='addQuestion' value='".$row['exam_id']."'>Add a Question</button>
                            <button type='submit' name='viewQuestion' value='".$row['exam_id']."'>View all Question</button>
                        </form>
                    </td></tr>";
                    $sno++;
                }
